...
public class TestJPA {
	...
	public void testCat1() {
		...
		try {
			...
			metier.ajouterCategorie(new Categorie("Ordinateurs", "Ordineuff",
					null, "image1.jpg"));
			metier.ajouterCategorie(new Categorie("imprimantes", "impocasion",
					null, "image2.jpg"));
	...
	public void testProduit() {
		...
		try {
			...
			metier.ajouterProduit(new Produit("HP4521ERT", "HP7890", 6000,3, true, "imag1.jpg"), 1L);
			metier.ajouterProduit(new Produit("DELL02ZE", "DELL7023", 8000,2, true, "imag2.jpg"), 1L);
